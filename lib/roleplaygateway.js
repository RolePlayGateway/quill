...
var roleplaygateway = new Maki(config);

var ObjectId = roleplaygateway.mongoose.Schema.Types.ObjectId;

roleplaygateway.use(require('maki-client-level'));
...
roleplaygateway.use(passport);
roleplaygateway.use(auth);

var Author = roleplaygateway.define('Author', {
  icon: 'users',
...
var Universe = roleplaygateway.define('Universe', {
  icon: 'book',
...
var Character = roleplaygateway.define('Character', {
  icon: 'user',
...
var Quest = roleplaygateway.define('Quest', {
  icon: 'protect',
...
var Bundle = roleplaygateway.define('Bundle', {
  icon: 'tags',
...
var Place = roleplaygateway.define('Place', {
  icon: 'globe',
...
var Post = roleplaygateway.define('Post', {
  icon: 'file text',
...
var Forum = roleplaygateway.define('Forum', {
  icon: 'unordered list',
...
var Topic = roleplaygateway.define('Topic', {
  icon: 'idea',
...
var Comment = roleplaygateway.define('Comment', {
  icon: 'comments',
...
var Task = roleplaygateway.define('Task', {
  icon: 'checkmark box',
...
module.exports = roleplaygateway;
